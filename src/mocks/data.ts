...
export const mockChallenge: Challenge = challengeJson

export const mockMissions: Mission[] = missionsJson

export const mockParticipants: Participant[] = participantsJson.map((p) => {
